...
export default function LanelyLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 relative overflow-x-hidden selection:bg-indigo-100 selection:text-indigo-900" style={{ backgroundColor: '#F8FAFC' }}>
      ...
      {/* Navigation Bar */}
      <nav className="fixed top-0 w-full z-50 transition-all duration-300 border-b border-white/20 bg-white/70 backdrop-blur-xl supports-[backdrop-filter]:bg-white/60" style={{ backdropFilter: 'blur(24px)', backgroundColor: 'rgba(255, 255, 255, 0.7)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-8" style={{ display: 'flex', gap: '32px' }}>
              <a href="#features" className="text-sm font-medium text-slate-500 hover:text-indigo-600 transition-colors" style={{ textDecoration: 'none', color: '#64748b' }}>Features</a>
              <a href="#coverage" className="text-sm font-medium text-slate-500 hover:text-indigo-600 transition-colors" style={{ textDecoration: 'none', color: '#64748b' }}>Network</a>
              <a href="#tracking" className="text-sm font-medium text-slate-500 hover:text-indigo-600 transition-colors" style={{ textDecoration: 'none', color: '#64748b' }}>Track Shipment</a>
            </div>

            {/* CTA Buttons */}
            <div className="hidden md:flex items-center gap-4" style={{ display: 'flex', gap: '16px' }}>
              <Link to="/loads" className="text-sm font-medium text-slate-600 hover:text-indigo-600 transition-colors" style={{ textDecoration: 'none', color: '#475569', fontWeight: 500 }}>
                Log in
              </Link>
              <Link to="/calculate-rate" className="bg-slate-900 hover:bg-indigo-600 text-white text-sm font-medium px-5 py-2.5 rounded-full transition-all shadow-lg hover:shadow-indigo-500/25 active:scale-95" style={{ backgroundColor: '#0f172a', color: 'white', textDecoration: 'none', borderRadius: '9999px', padding: '10px 20px' }}>
                Get a Quote
              </Link>
            </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-16 left-0 w-full bg-white/95 backdrop-blur-xl border-b border-slate-200 p-4 flex flex-col gap-4 shadow-xl animate-in slide-in-from-top-2">
            ...
            <div className="flex flex-col gap-3 mt-2">
              <Link to="/loads" className="text-slate-600 font-medium py-2">Log in</Link>
              <Link to="/calculate-rate" className="bg-indigo-600 text-white font-medium py-3 rounded-xl w-full text-center">Get a Quote</Link>
            </div>
          </div>
        )}
      </nav>
      ...
      {/* Hero Section */}
      <main className="relative z-10 pt-32 pb-20 lg:pt-48 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto" style={{ paddingTop: '128px', paddingBottom: '80px', maxWidth: '1280px', margin: '0 auto' }}>
